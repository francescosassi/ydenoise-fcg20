...
#bin/yscenetrace.exe tests/03_texture/texture.json -o out/lowres/03_texture_720_256.jpg -s 256 -r 720
...
bin/Release/yimagedenoise.exe out/original/01_cornellbox_512_256.jpg -o out/denoised/nlmeans/01_cornellbox_512_256_clean.png -t nlmean -s 23 -r 17 -f 3 -h 3